  ...
  return (
    <div className='featuredProducts'>
      <div className="top">
        <h1>{type} products</h1>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus praesentium, nemo suscipit molestias itaque rem animi. Nesciunt a, reprehenderit similique molestias mollitia rem doloremque tempore atque? Sunt, tempora eligendi. Explicabo distinctio iure dolores fuga doloremque id reprehenderit neque asperiores. Asperiores culpa numquam neque. Explicabo ut rem iste earum asperiores maiores?
        </p>
      </div>
